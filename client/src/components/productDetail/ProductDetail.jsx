...
function ProductDetail() {
    ...
    let product = products.filter(v => v.id === Number(id.productObject))
    product[0].amount = 1
        ...
        <div className="main-content1">
            ...
            <div className="row">
                <div className="col-3 float-left">
                    <div className="btnM"><Link to="/checkout">CHECK OUT</Link></div>
                </div>
            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-7 leftDetail">
                                <div class="images-slider">
                                    <ul class="slides">
                                        <li style={{display: 'block'}} data-thumb="images/large-img-1.jpg"> <img class="img-responsive" src={"d"}  alt=""/> </li>
                            ...
                            <div className="col-md-5 rightDetail">
                                <h4>wood chair</h4>
                                <div className="priceDetail"><small>$</small> {"d"} </div>
                                    ...
                                    <div className="row hehe">
                                        ...
                                        <div className="col-8">
                                            <ul className="colors-shop">
                                                <li><span className="mr-20">Colors :</span></li>
                                        ...
                                        <div onClick={addProduct} className="col-6 btnM">ADD TO CART</div>

                                        <div className="col-6 like-us"><i className="icon-heart"></i></div>
